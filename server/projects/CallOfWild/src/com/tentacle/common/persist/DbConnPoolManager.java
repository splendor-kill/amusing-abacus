...
public class DbConnPoolManager {
	private static final Logger logger = Logger.getLogger(DbConnPoolManager.class);	
	...
	private static class LazyHolder {
        public static final DbConnPoolManager INSTANCE = new DbConnPoolManager();
    }
    ...
    public static DbConnPoolManager getInst() {        
