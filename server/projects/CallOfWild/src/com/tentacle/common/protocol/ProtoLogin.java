...
public final class ProtoLogin {
  ...
  public static final class Account extends
    ...
    public com.tentacle.common.protocol.ProtoLogin.GameServer getFirstServer() {
      return firstServer_;
    }
    public com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder getFirstServerOrBuilder() {
      return firstServer_;
    }
    ...
    private void initFields() {
      ...
      password_ = "";
      email_ = "";
      firstServer_ = com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance();
      registerDate_ = 0L;
      cardId_ = "";
      platform_ = "";
      uid_ = "";
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Account parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Account parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.Account parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Account parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Account parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Account parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.Account prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.tentacle.common.protocol.ProtoLogin.Account.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.Account getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.Account.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.Account build() {
        com.tentacle.common.protocol.ProtoLogin.Account result = buildPartial();
      ...
      private com.tentacle.common.protocol.ProtoLogin.Account buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.Account result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.tentacle.common.protocol.ProtoLogin.Account buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.Account result = new com.tentacle.common.protocol.ProtoLogin.Account(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.Account) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.Account)other);
        } else {
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.Account other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.Account.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
        if (other.hasName()) {
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 42: {
              com.tentacle.common.protocol.ProtoLogin.GameServer.Builder subBuilder = com.tentacle.common.protocol.ProtoLogin.GameServer.newBuilder();
              if (hasFirstServer()) {
  ...
  bitField0_ |= 0x00000008;
      ...
      public Builder setFirstServer(com.tentacle.common.protocol.ProtoLogin.GameServer value) {
        if (firstServerBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFirstServer(
          com.tentacle.common.protocol.ProtoLogin.GameServer.Builder builderForValue) {
        if (firstServerBuilder_ == null) {
      ...
      public Builder mergeFirstServer(com.tentacle.common.protocol.ProtoLogin.GameServer value) {
        if (firstServerBuilder_ == null) {
          if (((bitField0_ & 0x00000010) == 0x00000010) &&
              firstServer_ != com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance()) {
            firstServer_ =
              com.tentacle.common.protocol.ProtoLogin.GameServer.newBuilder(firstServer_).mergeFrom(value).buildPartial();
          } else {
            firstServer_ = value;
          }
          onChanged();
      ...
      public com.tentacle.common.protocol.ProtoLogin.GameServer.Builder getFirstServerBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
      ...
      private com.google.protobuf.SingleFieldBuilder<
          com.tentacle.common.protocol.ProtoLogin.GameServer, com.tentacle.common.protocol.ProtoLogin.GameServer.Builder, com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder> 
          getFirstServerFieldBuilder() {
        if (firstServerBuilder_ == null) {
  ...
  public static final class AccountReq extends
    ...
    public com.tentacle.common.protocol.ProtoLogin.Account getAccount() {
      return account_;
    }
    public com.tentacle.common.protocol.ProtoLogin.AccountOrBuilder getAccountOrBuilder() {
      return account_;
    }
    
    private void initFields() {
      cmd_ = com.tentacle.common.protocol.ProtoBasis.Instruction.getDefaultInstance();
      account_ = com.tentacle.common.protocol.ProtoLogin.Account.getDefaultInstance();
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.AccountReq prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.tentacle.common.protocol.ProtoLogin.AccountReq.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.AccountReq getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.AccountReq.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.AccountReq build() {
        com.tentacle.common.protocol.ProtoLogin.AccountReq result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.tentacle.common.protocol.ProtoLogin.AccountReq buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.AccountReq result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.tentacle.common.protocol.ProtoLogin.AccountReq buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.AccountReq result = new com.tentacle.common.protocol.ProtoLogin.AccountReq(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.AccountReq) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.AccountReq)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.AccountReq other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.AccountReq.getDefaultInstance()) return this;
        if (other.hasCmd()) {
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              com.tentacle.common.protocol.ProtoLogin.Account.Builder subBuilder = com.tentacle.common.protocol.ProtoLogin.Account.newBuilder();
              if (hasAccount()) {
      ...
      public Builder setAccount(com.tentacle.common.protocol.ProtoLogin.Account value) {
        if (accountBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setAccount(
          com.tentacle.common.protocol.ProtoLogin.Account.Builder builderForValue) {
        if (accountBuilder_ == null) {
      ...
      public Builder mergeAccount(com.tentacle.common.protocol.ProtoLogin.Account value) {
        if (accountBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
              account_ != com.tentacle.common.protocol.ProtoLogin.Account.getDefaultInstance()) {
            account_ =
              com.tentacle.common.protocol.ProtoLogin.Account.newBuilder(account_).mergeFrom(value).buildPartial();
          } else {
            account_ = value;
          }
          onChanged();
      ...
      public com.tentacle.common.protocol.ProtoLogin.Account.Builder getAccountBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
      ...
      private com.google.protobuf.SingleFieldBuilder<
          com.tentacle.common.protocol.ProtoLogin.Account, com.tentacle.common.protocol.ProtoLogin.Account.Builder, com.tentacle.common.protocol.ProtoLogin.AccountOrBuilder> 
          getAccountFieldBuilder() {
        if (accountBuilder_ == null) {
  ...
  public interface AccountAnsOrBuilder
    ...
    int getServersCount();
    java.util.List<? extends com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder> 
        getServersOrBuilderList();
    com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder getServersOrBuilder(
        int index);
  }
  public static final class AccountAns extends
    ...
    public java.util.List<? extends com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder> 
        getServersOrBuilderList() {
      return servers_;
    }
    ...
    public com.tentacle.common.protocol.ProtoLogin.GameServer getServers(int index) {
      return servers_.get(index);
    }
    public com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder getServersOrBuilder(
        int index) {
      return servers_.get(index);
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.tentacle.common.protocol.ProtoLogin.AccountAns parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.AccountAns prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.tentacle.common.protocol.ProtoLogin.AccountAns.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.AccountAns getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.AccountAns.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.AccountAns build() {
        com.tentacle.common.protocol.ProtoLogin.AccountAns result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.tentacle.common.protocol.ProtoLogin.AccountAns buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.AccountAns result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.tentacle.common.protocol.ProtoLogin.AccountAns buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.AccountAns result = new com.tentacle.common.protocol.ProtoLogin.AccountAns(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.AccountAns) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.AccountAns)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.AccountAns other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.AccountAns.getDefaultInstance()) return this;
        if (other.hasCmd()) {
          mergeCmd(other.getCmd());
        }
        if (other.hasErrCode()) {
  ...
  bitField0_ |= 0x00000010;
      ...
      private void ensureServersIsMutable() {
        if (!((bitField0_ & 0x00000040) == 0x00000040)) {
          servers_ = new java.util.ArrayList<com.tentacle.common.protocol.ProtoLogin.GameServer>(servers_);
          bitField0_ |= 0x00000040;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          com.tentacle.common.protocol.ProtoLogin.GameServer, com.tentacle.common.protocol.ProtoLogin.GameServer.Builder, com.tentacle.common.protocol.ProtoLogin.GameServerOrBuilder> serversBuilder_;
      ...
      public Builder setServers(
          int index, com.tentacle.common.protocol.ProtoLogin.GameServer value) {
        if (serversBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setServers(
          int index, com.tentacle.common.protocol.ProtoLogin.GameServer.Builder builderForValue) {
        if (serversBuilder_ == null) {
          ensureServersIsMutable();
      ...
      public Builder addServers(com.tentacle.common.protocol.ProtoLogin.GameServer value) {
        if (serversBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllServers(
          java.lang.Iterable<? extends com.tentacle.common.protocol.ProtoLogin.GameServer> values) {
        if (serversBuilder_ == null) {
          ensureServersIsMutable();
      ...
      public com.tentacle.common.protocol.ProtoLogin.GameServer.Builder getServersBuilder(
          int index) {
      ...
      public com.tentacle.common.protocol.ProtoLogin.GameServer.Builder addServersBuilder() {
        return getServersFieldBuilder().addBuilder(
            com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance());
      }
      public com.tentacle.common.protocol.ProtoLogin.GameServer.Builder addServersBuilder(
          int index) {
        return getServersFieldBuilder().addBuilder(
            index, com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance());
      }
      public java.util.List<com.tentacle.common.protocol.ProtoLogin.GameServer.Builder> 
  ...
  public static final class GameServer extends
    ...
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.tentacle.common.protocol.ProtoLogin.GameServer parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.GameServer prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.tentacle.common.protocol.ProtoLogin.GameServer.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.GameServer getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.GameServer build() {
        com.tentacle.common.protocol.ProtoLogin.GameServer result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.tentacle.common.protocol.ProtoLogin.GameServer buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.GameServer result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.tentacle.common.protocol.ProtoLogin.GameServer buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.GameServer result = new com.tentacle.common.protocol.ProtoLogin.GameServer(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.GameServer) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.GameServer)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.GameServer other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.GameServer.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
        if (other.hasName()) {
  ...
  public static final class VersionInfo extends
    ...
    public com.tentacle.common.protocol.ProtoBasis.MyVariant getMoreInfo() {
      return moreInfo_;
    }
    public com.tentacle.common.protocol.ProtoBasis.MyVariantOrBuilder getMoreInfoOrBuilder() {
      return moreInfo_;
    }
    ...
    private void initFields() {
      ...
      isCompulsive_ = false;
      channel_ = "";
      moreInfo_ = com.tentacle.common.protocol.ProtoBasis.MyVariant.getDefaultInstance();
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
    ...
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.tentacle.common.protocol.ProtoLogin.VersionInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.VersionInfo prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.tentacle.common.protocol.ProtoLogin.VersionInfo.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.VersionInfo getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.VersionInfo.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.VersionInfo build() {
        com.tentacle.common.protocol.ProtoLogin.VersionInfo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.tentacle.common.protocol.ProtoLogin.VersionInfo buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.VersionInfo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.tentacle.common.protocol.ProtoLogin.VersionInfo buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.VersionInfo result = new com.tentacle.common.protocol.ProtoLogin.VersionInfo(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.VersionInfo) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.VersionInfo)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.VersionInfo other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.VersionInfo.getDefaultInstance()) return this;
        if (other.hasCmd()) {
          mergeCmd(other.getCmd());
        }
        if (other.hasErrCode()) {
  ...
  bitField0_ |= 0x00000020;
      ...
      public Builder setMoreInfo(com.tentacle.common.protocol.ProtoBasis.MyVariant value) {
        if (moreInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder mergeMoreInfo(com.tentacle.common.protocol.ProtoBasis.MyVariant value) {
        if (moreInfoBuilder_ == null) {
          if (((bitField0_ & 0x00000040) == 0x00000040) &&
              moreInfo_ != com.tentacle.common.protocol.ProtoBasis.MyVariant.getDefaultInstance()) {
            moreInfo_ =
              com.tentacle.common.protocol.ProtoBasis.MyVariant.newBuilder(moreInfo_).mergeFrom(value).buildPartial();
          } else {
            moreInfo_ = value;
          }
          onChanged();
      ...
      public com.tentacle.common.protocol.ProtoBasis.MyVariant.Builder getMoreInfoBuilder() {
        bitField0_ |= 0x00000040;
        onChanged();
  ...
  public static final class Authentication extends
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseFrom(
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.tentacle.common.protocol.ProtoLogin.Authentication parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.tentacle.common.protocol.ProtoLogin.Authentication prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.tentacle.common.protocol.ProtoLogin.Authentication.getDescriptor();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.Authentication getDefaultInstanceForType() {
        return com.tentacle.common.protocol.ProtoLogin.Authentication.getDefaultInstance();
      }
      
      public com.tentacle.common.protocol.ProtoLogin.Authentication build() {
        com.tentacle.common.protocol.ProtoLogin.Authentication result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.tentacle.common.protocol.ProtoLogin.Authentication buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.tentacle.common.protocol.ProtoLogin.Authentication result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.tentacle.common.protocol.ProtoLogin.Authentication buildPartial() {
        com.tentacle.common.protocol.ProtoLogin.Authentication result = new com.tentacle.common.protocol.ProtoLogin.Authentication(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.tentacle.common.protocol.ProtoLogin.Authentication) {
          return mergeFrom((com.tentacle.common.protocol.ProtoLogin.Authentication)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.tentacle.common.protocol.ProtoLogin.Authentication other) {
        if (other == com.tentacle.common.protocol.ProtoLogin.Authentication.getDefaultInstance()) return this;
        if (other.hasCmd()) {
          mergeCmd(other.getCmd());
        }
        if (other.hasErrCode()) {
